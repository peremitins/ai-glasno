...
const initialWorkspace: InterviewWorkspace = {
  ...
  currentTurn: {
    ...
    hintPack: {
      focus: "Покажите практический критерий выбора между type и interface.",
      structure:
        "Сначала сформулируйте отличие, затем приведите короткий пример и объясните выбор.",
      bullets: [
        "Сравните расширение и декларативное слияние.",
        "Покажите пример описания объекта.",
        "Свяжите выбор с ограничениями конкретного проекта.",
      ],
    },
    answer: null,
    messages: [
    ...
    async ({ params, request }) => {
      ...
      workspace = {
        ...
        currentTurn: {
          ...
          hintPack: {
            focus:
              "Покажите, как unknown сохраняет контроль над неизвестными данными.",
            structure:
              "Опишите риск any, затем покажите проверку типа перед использованием значения.",
            bullets: [
              "Назовите источник неизвестного значения.",
              "Покажите type guard или другую проверку.",
              "Объясните, почему any здесь опаснее.",
            ],
          },
          answer: null,
          messages: [
